...
function FILE_CLASS() {
	...
	//show images
	/*this.file_b1 = function(){
		POP.add({name: "url", title: "URL:", value:"img/b1.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};

	this.file_b2 = function(){
		POP.add({name: "url", title: "URL:", value:"img/b2.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_v1 = function(){
		POP.add({name: "url", title: "URL:", value:"img/v1.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_v2 = function(){
		POP.add({name: "url", title: "URL:", value:"img/v2.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	*/
...
this.file_open = function () {
	...
	this.file_b3 = function(){
		POP.add({name: "url", title: "URL:", value:"img/b3.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_b4 = function(){
		POP.add({name: "url", title: "URL:", value:"img/b4.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_b5 = function(){
		POP.add({name: "url", title: "URL:", value:"img/b5.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_b6 = function(){
		POP.add({name: "url", title: "URL:", value:"img/b6.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_v1 = function(){
		POP.add({name: "url", title: "URL:", value:"img/v1.jpg"});
	...
	this.file_v3 = function(){
		POP.add({name: "url", title: "URL:", value:"img/v3.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_v4 = function(){
		POP.add({name: "url", title: "URL:", value:"img/v4.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_v5 = function(){
		POP.add({name: "url", title: "URL:", value:"img/v5.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_v6 = function(){
		POP.add({name: "url", title: "URL:", value:"img/v6.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_w1 = function(){
		POP.add({name: "url", title: "URL:", value:"img/w1.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	
	this.file_w2 = function(){
		POP.add({name: "url", title: "URL:", value:"img/w2.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_w3 = function(){
		POP.add({name: "url", title: "URL:", value:"img/w3.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_w4 = function(){
		POP.add({name: "url", title: "URL:", value:"img/w4.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_w5 = function(){
		POP.add({name: "url", title: "URL:", value:"img/w5.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_w6 = function(){
		POP.add({name: "url", title: "URL:", value:"img/w6.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_g1 = function(){
		POP.add({name: "url", title: "URL:", value:"img/g1.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	
	this.file_g2 = function(){
		POP.add({name: "url", title: "URL:", value:"img/g2.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_g3 = function(){
		POP.add({name: "url", title: "URL:", value:"img/g3.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_g4 = function(){
		POP.add({name: "url", title: "URL:", value:"img/g4.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_g5 = function(){
		POP.add({name: "url", title: "URL:", value:"img/g5.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_g6 = function(){
		POP.add({name: "url", title: "URL:", value:"img/g6.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_s1 = function(){
		POP.add({name: "url", title: "URL:", value:"img/s1.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	
	this.file_s2 = function(){
		POP.add({name: "url", title: "URL:", value:"img/s2.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_s3 = function(){
		POP.add({name: "url", title: "URL:", value:"img/s3.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_s4 = function(){
		POP.add({name: "url", title: "URL:", value:"img/s4.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_s5 = function(){
		POP.add({name: "url", title: "URL:", value:"img/s5.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_s6 = function(){
		POP.add({name: "url", title: "URL:", value:"img/s6.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_f1 = function(){
		POP.add({name: "url", title: "URL:", value:"img/f1.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_f2 = function(){
		POP.add({name: "url", title: "URL:", value:"img/f2.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_f3 = function(){
		POP.add({name: "url", title: "URL:", value:"img/f3.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_f4 = function(){
		POP.add({name: "url", title: "URL:", value:"img/f4.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_f5 = function(){
		POP.add({name: "url", title: "URL:", value:"img/f5.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
	this.file_f6 = function(){
		POP.add({name: "url", title: "URL:", value:"img/f6.jpg"});
		POP.show(' Confirm URL', [FILE, 'file_open_url_handler']);
		};
